...
public class Physics2D {
    ...
    public void update(float dt) {
        ...
        if (physicsTime >= 0.0f) {
            ...
            world.step(physicsTime, velocityIterations, (int) physicsTimeStep);
        }
    }

    public void setIsSenor(Rigidbody2D rb) {
    ...
    public void setNotSenor(Rigidbody2D rb) {
        Body body = rb.getRawBody();
        if (body == null) return;
    ...
    public void resetCirleCollider(Rigidbody2D rb, CircleCollider circleCollider) {
        Body body = rb.getRawBody();
        if (body == null) return;
